...
localparam S_READ_SOURCE_1_LO   = 5'd3;     // Read source pixel 1: low 16 bits
localparam S_READ_SOURCE_1_HI   = 5'd4;     // Read source pixel 1: high 16 bits
localparam S_READ_SOURCE_2_LO   = 5'd5;     // Read source pixel 2: low 16 bits
localparam S_READ_SOURCE_2_HI   = 5'd6;     // Read source pixel 2: high 16 bits
localparam S_READ_TARGET_1_LO   = 5'd7;     // Read target pixel 1: low 16 bits
localparam S_READ_TARGET_1_HI   = 5'd8;     // Read target pixel 1: high 16 bits
localparam S_READ_TARGET_2_LO   = 5'd9;     // Read target pixel 2: low 16 bits
localparam S_READ_TARGET_2_HI   = 5'd10;    // Read target pixel 2: high 16 bits
localparam S_CALC_LOSS          = 5'd11;    // Calculate loss and decide swap
localparam S_WRITE_SOURCE_1_LO  = 5'd12;    // Write source pixel 1: low 16 bits
localparam S_WRITE_SOURCE_1_HI  = 5'd13;    // Write source pixel 1: high 16 bits
localparam S_WRITE_SOURCE_2_LO  = 5'd14;    // Write source pixel 2: low 16 bits
localparam S_WRITE_SOURCE_2_HI  = 5'd15;    // Write source pixel 2: high 16 bits
localparam S_NEXT_ITER          = 5'd16;    // Move to next iteration
localparam S_EPOCH_DONE         = 5'd17;    // Epoch finished, wait for next epoch
localparam S_FINISHED           = 5'd18;    // All epochs finished
